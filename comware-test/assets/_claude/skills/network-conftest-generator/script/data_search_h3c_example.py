...
def search_code(index_name, keyword_query):
    ...
    if index_name == "v9_press_example":
        ...
        vector_field  = "backGround_vector"
        size_num = 2
        ...
        return "数据库indexname 不存在，当前仅支持v9_press_example，background_ke， example_ke,testcenter_ke, cmd_ke"
    ...
    try:
        ...
        if index_name == "background_ke":
            for iter in structured_results:
                iter_dict ={
                    'title'     : iter['source']['file_path'],
