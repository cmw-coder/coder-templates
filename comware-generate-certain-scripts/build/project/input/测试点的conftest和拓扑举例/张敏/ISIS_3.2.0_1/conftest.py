...
class CVarsAndFuncs:
    '''
    测试背景：
    3台设备组网，DUT1、DUT2建立ISIS 1的邻居，DUT2和DUT3建立ISIS 1的邻居，三台设备均配置成L2，在DUT3上配置一个loopback，loopback下配置一条ip路由，使能isis
    '''
    pass
